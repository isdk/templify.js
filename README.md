...
running command...
$ templify (--version)
@isdk/templify/0.3.6 linux-x64 node-v20.18.0
...
_See code: [src/commands/apply/index.ts](https://github.com/isdk/templify.js/blob/v0.3.6/src/commands/apply/index.ts)_
...
_See code: [src/commands/scan/index.ts](https://github.com/isdk/templify.js/blob/v0.3.6/src/commands/scan/index.ts)_
